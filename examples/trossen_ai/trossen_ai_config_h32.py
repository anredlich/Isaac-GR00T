...
trossen_ai_config_h32 = {
    ...
    # Action: 32-step (was 16) prediction horizon. Same key structure as state.
...
register_modality_config(trossen_ai_config_h32, embodiment_tag=EmbodimentTag.NEW_EMBODIMENT)
